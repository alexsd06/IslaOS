...
#define image _binary_isla_isla_tga_start
...
void read_image()
{
    ...
    //tga_header_t image=_binary_isla_isla_normal_tga_start;
    uint32_t  *isla_normal = (uint32_t*) &_binary_isla_isla_tga_start;
